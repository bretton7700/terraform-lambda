...
resource "aws_iam_role_policy" "mypython_lambda_role_policy" {
  name = "mypython_lambda_role_policy_${terraform.workspace}"
  role = aws_iam_role.mypython_lambda_role.id
